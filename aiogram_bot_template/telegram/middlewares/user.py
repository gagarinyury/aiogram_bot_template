...
from aiogram_bot_template.services.crud.user import UserService
from aiogram_bot_template.telegram.middlewares.event_typed import EventTypedMiddleware
from aiogram_bot_template.utils.logging import database as logger
